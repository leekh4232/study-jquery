function getFormData(params) {
    // param이 Event객체이거나 HTMLFormElement인 경우 jQuery 객체로 변환
    switch (params.constructor) {
        case SubmitEvent:
            params = $(params.currentTarget);
            break;
    ...
    const formData = params.serializeArray();
    const jsonData = {};
...
$.ajaxSetup({
    ...
    beforeSend: function () {
        ...
        // 로딩바를 화면에 표시함 --> 로딩바는 AjaxSetup.js 마지막에 정의됨
        loader.show();
    },
